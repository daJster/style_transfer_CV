...
CONTENT_WEIGHT = 1e-2 # 8e-4 # test different values
...
if __name__ == "__main__":
    ...
    for iter in range(n_iter):
        with tf.GradientTape() as tape:
            total_loss, loss_content, loss_style, loss_total_variation = compute_loss(model, generated_image, content_features, style_features1)
